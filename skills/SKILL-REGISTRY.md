...
|---|---|---|---|---|
| Qdrant | `docs/03-runbooks/HX-10/` | `smoke-tests/qdrant-smoke-test.md` | `smoke-tests/native-web-ui-smoke-test.md`, `smoke-tests/mcp-companion-smoke-test.md` | 2026-09-09 — structure/frontmatter reviewed; no HX execution authority granted |
| LightRAG | `docs/03-runbooks/HX-11/` | `smoke-tests/lightrag-smoke-test.md` | `smoke-tests/mcp-companion-smoke-test.md` | 2026-09-09 — structure/frontmatter reviewed; no HX execution authority granted |
| PostgreSQL | `docs/03-runbooks/HX-9/` | `smoke-tests/postgresql-smoke-test.md` | `smoke-tests/mcp-companion-smoke-test.md` | 2026-09-09 — structure/frontmatter reviewed; no HX execution authority granted |
| Redis | `docs/03-runbooks/HX-9/` | `smoke-tests/redis-smoke-test.md` | `smoke-tests/mcp-companion-smoke-test.md` | 2026-09-09 — structure/frontmatter reviewed; `skills/redis/hx-redis-advisor/scripts/redis-readonly-audit.sh` is read-only |
| Mem0 | `docs/03-runbooks/HX-13/` | `smoke-tests/mem0-smoke-test.md` | `smoke-tests/mcp-companion-smoke-test.md` — implementation not yet selected | 2026-09-09 — structure/frontmatter reviewed; no HX execution authority granted |
| Docling / Granite-Docling | `docs/03-runbooks/HX-16/` | `smoke-tests/docling-smoke-test.md` | `smoke-tests/mcp-companion-smoke-test.md` | 2026-09-09 — structure/frontmatter reviewed; no HX execution authority granted |
| Crawl4AI | `docs/03-runbooks/HX-17/` | `smoke-tests/crawl4ai-smoke-test.md` | `smoke-tests/mcp-companion-smoke-test.md` — native implementation not yet selected | 2026-09-09 — structure/frontmatter reviewed; no HX execution authority granted |
...
| OmniRoute | HX-6 | TBD | `diegosouzapw/OmniRoute` — owner-confirmed 2026-09-10 (D-019) | `DISCOVERY` | provider/model routing/configuration |
