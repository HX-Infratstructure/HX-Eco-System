...
# unit to start and a port to prove. The exact service entry point is an HX-13
# runbook decision; record it here once chosen.
hx_app_done hx-mem0 "$HX_HOST" "Mem0 ${HX_MEM0_VERSION}"
