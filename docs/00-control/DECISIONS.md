...
# HX Eco-System â€” Owner-Approved Decisions

## D-001 â€” Clean-room rebuild
...
## D-005 â€” Embedding/reranking placement
...
## D-006 â€” Granite-Docling placement
...
## D-008 â€” Open WebUI base functional test
...
## D-009 â€” OmniRoute base functional test
...
## D-010 â€” OmniRoute provider/model catalog
...
## D-012 â€” DeepSeek Harness meta-agent role
...
## D-013 â€” Deep Agents LOB agent factory role
...
## D-014 â€” HX-5 CentCom smoke-test runner role
...
## D-015 â€” Ecosystem architecture is the cornerstone
...
## D-016 â€” Ordered smoke-test proof roadmap
...
## D-017 â€” Governed HX skills capability layer
...
## D-018 â€” Host firewall and inference listener posture â€” RATIFIED 2026-09-11
...
## D-019 â€” OmniRoute product identity â€” RATIFIED 2026-09-10
...
## D-020 â€” PostgreSQL install source â€” RATIFIED 2026-09-10
...
## D-021 â€” Snap is never a package source â€” RATIFIED 2026-09-11
...
## D-022 â€” BGE reranker checkpoint and runtime â€” RATIFIED 2026-09-10
...
## D-023 â€” a write-capable token in Actions secrets, for OpenWiki â€” SUPERSEDED BY D-025 on 2026-09-14

Withdrawn: the scheduled OpenWiki workflow is deleted and generation is manual
from a host-agent session, the fallback this entry itself recorded. The
conditions and risk analysis below stay as the historical record and as the
conditions any reversal must re-establish.
...
- `OPENWIKI_PR_TOKEN` â€” a fine-grained personal access token or GitHub App
  token, scoped to this repository only, with **Contents: read and write** and
  **Pull requests: read and write**;
- `ANTHROPIC_API_KEY` â€” a model key. Every scheduled run is billable.
...
## D-025 â€” OpenWiki generation is manual, not scheduled â€” RATIFIED 2026-09-14
...
and the
`workflow_dispatch` residual risk D-023 documented â€” a branch that edits the
workflow file can read both secrets, and no line inside the file can prevent
it â€” goes away with the file.
