# HX-11 — LightRAG + MCP Server Configuration

**Build state:** NOT STARTED
**Gate:** —
**IP:** `192.168.50.211`
**FQDN:** `hx-11.hx.local.arpa`
**Record updated:** 2026-09-10
> Scaffolded by `tools/hx-doc/hx-new-server hx-11`. Fill every section as the
...
|---|---|---|
| `hostname -f` | `hx-11.hx.local.arpa` | NOT ESTABLISHED |
...
| External key-only login | `tools/hx-doc/hx-fleet-access hx-11` returns `hx-11` and `KEY+SUDO-PASS` | NOT ESTABLISHED |
