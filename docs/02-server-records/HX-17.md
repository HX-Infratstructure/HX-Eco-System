# HX-17 — Crawl4AI + MCP Server Configuration

**Build state:** NOT STARTED
**Gate:** —
**IP:** `192.168.50.217`
**FQDN:** `hx-17.hx.local.arpa`
**Record updated:** 2026-09-10
> Scaffolded by `tools/hx-doc/hx-new-server hx-17`. Fill every section as the
...
|---|---|---|
| `hostname -f` | `hx-17.hx.local.arpa` | NOT ESTABLISHED |
...
| External key-only login | `tools/hx-doc/hx-fleet-access hx-17` returns `hx-17` and `KEY+SUDO-PASS` | NOT ESTABLISHED |
