# HX-14 — n8n + MCP Server Configuration

**Build state:** NOT STARTED
**Gate:** —
**IP:** `192.168.50.214`
**FQDN:** `hx-14.hx.local.arpa`
**Record updated:** 2026-09-10
> Scaffolded by `tools/hx-doc/hx-new-server hx-14`. Fill every section as the
...
|---|---|---|
| `hostname -f` | `hx-14.hx.local.arpa` | NOT ESTABLISHED |
...
| External key-only login | `tools/hx-doc/hx-fleet-access hx-14` returns `hx-14` and `KEY+SUDO-PASS` | NOT ESTABLISHED |
