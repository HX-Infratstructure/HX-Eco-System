# HX-13 — Mem0 + assigned MCP Server Configuration

**Build state:** NOT STARTED
**Gate:** —
**IP:** `192.168.50.213`
**FQDN:** `hx-13.hx.local.arpa`
**Record updated:** 2026-09-10
> Scaffolded by `tools/hx-doc/hx-new-server hx-13`. Fill every section as the
...
|---|---|---|
| `hostname -f` | `hx-13.hx.local.arpa` | NOT ESTABLISHED |
...
| External key-only login | `tools/hx-doc/hx-fleet-access hx-13` returns `hx-13` and `KEY+SUDO-PASS` | NOT ESTABLISHED |
