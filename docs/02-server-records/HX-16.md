# HX-16 — Docling + Granite-Docling 258M + MCP Server Configuration

**Build state:** NOT STARTED
**Gate:** —
**IP:** `192.168.50.216`
**FQDN:** `hx-16.hx.local.arpa`
**Record updated:** 2026-09-10
> Scaffolded by `tools/hx-doc/hx-new-server hx-16`. Fill every section as the
...
|---|---|---|
| `hostname -f` | `hx-16.hx.local.arpa` | NOT ESTABLISHED |
...
| External key-only login | `tools/hx-doc/hx-fleet-access hx-16` returns `hx-16` and `KEY+SUDO-PASS` | NOT ESTABLISHED |
