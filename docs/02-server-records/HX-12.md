# HX-12 — Deep Agents (LangChain) LOB agent factory Server Configuration

**Build state:** NOT STARTED
**Gate:** —
**IP:** `192.168.50.212`
**FQDN:** `hx-12.hx.local.arpa`
**Record updated:** 2026-09-10
> Scaffolded by `tools/hx-doc/hx-new-server hx-12`. Fill every section as the
...
|---|---|---|
| `hostname -f` | `hx-12.hx.local.arpa` | NOT ESTABLISHED |
...
| External key-only login | `tools/hx-doc/hx-fleet-access hx-12` returns `hx-12` and `KEY+SUDO-PASS` | NOT ESTABLISHED |
