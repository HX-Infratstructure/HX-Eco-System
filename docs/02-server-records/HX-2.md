...
| SPNs in AD | `host/HX-2`, `RestrictedKrbHost/HX-2` present; `host/hx-2.hx.local.arpa` and `RestrictedKrbHost/hx-2.hx.local.arpa` **absent**; `dNSHostName` is `hx-2`, not the FQDN | GAP, see HX5-F12 |
