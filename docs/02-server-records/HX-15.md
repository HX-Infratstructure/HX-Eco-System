# HX-15 — FastMCP shared/custom MCP development host Server Configuration

**Build state:** NOT STARTED
**Gate:** —
**IP:** `192.168.50.215`
**FQDN:** `hx-15.hx.local.arpa`
**Record updated:** 2026-09-10
> Scaffolded by `tools/hx-doc/hx-new-server hx-15`. Fill every section as the
...
|---|---|---|
| `hostname -f` | `hx-15.hx.local.arpa` | NOT ESTABLISHED |
...
| External key-only login | `tools/hx-doc/hx-fleet-access hx-15` returns `hx-15` and `KEY+SUDO-PASS` | NOT ESTABLISHED |
