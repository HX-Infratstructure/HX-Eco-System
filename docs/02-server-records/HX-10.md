# HX-10 — Qdrant + Web UI + MCP Server Configuration

**Build state:** NOT STARTED
**Gate:** —
**IP:** `192.168.50.210`
**FQDN:** `hx-10.hx.local.arpa`
**Record updated:** 2026-09-10
> Scaffolded by `tools/hx-doc/hx-new-server hx-10`. Fill every section as the
...
|---|---|---|
| `hostname -f` | `hx-10.hx.local.arpa` | NOT ESTABLISHED |
...
| External key-only login | `tools/hx-doc/hx-fleet-access hx-10` returns `hx-10` and `KEY+SUDO-PASS` | NOT ESTABLISHED |
